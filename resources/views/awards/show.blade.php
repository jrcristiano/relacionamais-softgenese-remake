        ...
        <div class="col-lg-10 sgi-container shadow-sm rounded p-0">
            ...
            <table id="client_table" class="table table-sm table-striped table-hover">
                ...
                <tbody>
                    @forelse ($spreadsheets as $spreadsheet)
                        <tr>
                            ...
                            <td>
                                ...
                                <form class="d-inline sgi_form_delete" action="{{ route('admin.register.spreadsheets.delete', [ 'id' => $spreadsheet->id ]) }}" method="post">
                                    @csrf
                    ...
                    @empty
                        <td colspan="10" ><i class="fas fa-frown"></i> Nenhuma premiação ainda registrada...</td>
                    @endforelse
                </tbody>
            </table>

            @if ($spreadsheets->count() >= 100)
