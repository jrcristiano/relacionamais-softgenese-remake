                ...
                <tbody>
                    @forelse ($acessoCards as $acessoCard)
                        <tr>
                            ...
                            <td>{{ $acessoCard->acesso_card_number ? $acessoCard->base_acesso_card_proxy : null }}</td>
                            <td>{{ $acessoCard->acesso_card_number ? $acessoCard->base_acesso_card_number : 'EMITIR CARTÃO' }}</td>
