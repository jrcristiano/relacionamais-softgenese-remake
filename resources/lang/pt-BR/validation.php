...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'demand_client_cnpj'    => 'empresa',
        'demand_prize_amount'   => 'valor de premiação',
        'demand_taxable_amount' => 'valor tributável',

        'client_company' => 'nome da empresa',
        'client_address' => 'endereço',
        'client_phone' => 'telefone',
        'client_responsable_name' => 'nome do responsável',
        'client_cnpj' => 'cnpj',
        'client_manager' => 'gerente',
        'client_rate_admin' => 'taxa de administração',
        'client_comission_manager' => 'comissão do gerente',
        'client_reg_state' => 'inscrição estadual',

        'provider_name' => 'nome do fornecedor',
        'provider_address' => 'endereço',
        'provider_cnpj' => 'cpf/cnpj',

        'awarded_value'         => 'valor de premiação',
        'awarded_type'          => 'tipo de premiação',
        'awarded_type_card'     => 'tipo de cartão',
        'awarded_status'        => 'status de premiação',
    ],
];
