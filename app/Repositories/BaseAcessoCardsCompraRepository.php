...
class BaseAcessoCardsCompraRepository extends Repository
{
    protected $repository;

    public function __construct(BaseAcessoCardsCompra $baseAcessoCardsCompra)
    {
        $this->repository = $baseAcessoCardsCompra;
    }
    ...
    public function getBaseAcessoCardActiveByDocument($document)
    {
        return $this->repository
            ->where('base_acesso_card_cpf', $document)
            ->where('base_acesso_card_status', 1)
            ->orderBy('base_acesso_cards_compras.updated_at', 'desc')
            ->get();
    }
    ...
    {
        return $this->repository
            ->leftJoin('base_acesso_cards_compra_orders', 'base_acesso_cards_compras.id', '=', 'base_acesso_cards_compra_orders.currency_card_id')
            ->leftJoin('call_centers', 'base_acesso_cards_compra_orders.call_center_id', '=', 'call_centers.id')
            ->where('base_acesso_card_cpf', $document)
            ->orderBy('base_acesso_cards_compras.updated_at', 'desc')
            ->where('base_acesso_cards_compra_orders.call_center_id', $id)
            ->first();
    }
    ...
    {
        return $this->repository
            ->leftJoin('base_acesso_cards_compra_orders', 'base_acesso_cards_compras.id', '=', 'base_acesso_cards_compra_orders.previous_card_id')
            ->leftJoin('call_centers', 'base_acesso_cards_compra_orders.call_center_id', '=', 'call_centers.id')
            ->where('base_acesso_card_cpf', $document)
            ->orderBy('base_acesso_cards_compras.updated_at', 'desc')
            ->where('base_acesso_cards_compra_orders.call_center_id', $id)
    ...
    {
        return $this->repository->leftJoin('acesso_cards', 'base_acesso_cards_compras.base_acesso_card_cpf', '=', 'acesso_cards.acesso_card_document')
    ...
    public function findByCard($card)
    {
        ...
        ->leftJoin('acesso_cards', 'base_acesso_cards_compras.base_acesso_card_number', '=', 'acesso_cards.acesso_card_number')
    ...
    public function getAcessoCardCompletoNotGenerated($id)
    {
        ...
        ->leftJoin('acesso_cards', 'base_acesso_cards_compras.base_acesso_card_proxy', '=', 'acesso_cards.acesso_card_proxy')
        ->whereNull('base_acesso_card_generated')
        ->whereNotNull('base_acesso_cards_compras.base_acesso_card_name')
        ->whereNotNull('base_acesso_cards_compras.base_acesso_card_cpf')
    ...
    public function firstAcessoCardCompletoNotGenerated($id)
    {
        ...
        ->leftJoin('acesso_cards', 'base_acesso_cards_compras.base_acesso_card_cpf', '=', 'acesso_cards.acesso_card_document')
        ->whereNull('base_acesso_card_generated')
        ->whereNotNull('base_acesso_cards_compras.base_acesso_card_name')
        ->whereNotNull('base_acesso_cards_compras.base_acesso_card_cpf')
        ->where('acesso_cards.acesso_card_award_id', $id)
    ...
    {
        return $this->repository->select('base_acesso_cards_compras.base_acesso_card_proxy')
            ->join('base_acesso_cards_compra_orders', 'base_acesso_cards_compras.id', '=', 'base_acesso_cards_compra_orders.currency_card_id')
            ->orderBy('base_acesso_cards_compras.id', 'desc')
            ->where('base_acesso_cards_compra_orders.previous_card_id', $id)
            ->where('base_acesso_cards_compra_orders.call_center_id', $callCenterId)
            ->first();
    }
    ...
    {
        return $this->repository->select('base_acesso_cards_compras.base_acesso_card_proxy')
            ->join('base_acesso_cards_compra_orders', 'base_acesso_cards_compras.id', '=', 'base_acesso_cards_compra_orders.previous_card_id')
            ->orderBy('base_acesso_cards_compras.id', 'desc')
            ->where('base_acesso_cards_compra_orders.previous_card_id', $id)
            ->where('base_acesso_cards_compra_orders.call_center_id', $callCenterId)
            ->first();
