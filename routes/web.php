...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'auth', 'as' => 'admin.'], function () {
        ...
        Route::post('/pedido/loja', 'DemandController@store')->name('store');
        ...
        Route::group(['prefix' => 'cadastrar', 'as' => 'register.'], function () {
            ...
            Route::post('/cliente/loja', 'ClientController@store')->name('clients.store');
            ...
            Route::post('/premiado/loja', 'AwardController@store')->name('awardeds.store');
            ...
            Route::post('/deposito-manual/loja', 'ManualDepositController@store')->name('manual-deposits.store');
            Route::get('/deposito-manual/{id}/editar', 'ManualDepositController@edit')->name('manual-deposits.edit');
            Route::put('/deposito-manual/atualizar', 'ManualDepositController@update')->name('manual-deposits.update');
            ...
            Route::post('/fornecedor/loja', 'ProviderController@store')->name('providers.store');
            ...
            Route::post('/gerente/loja', 'ManagerController@store')->name('managers.store');
            ...
            Route::post('/banco/loja', 'BankController@store')->name('banks.store');
        ...
        Route::group(['prefix' => 'financeiro', 'as' => 'financial.'], function () {
            ...
            Route::post('/conta-a-pagar/loja', 'BillController@store')->name('bills.store');
            ...
            Route::post('/conta-a-receber/loja', 'ReceiveController@store')->name('receives.store');
            ...
            Route::post('/nota-fiscal/loja', 'NoteController@store')->name('notes.store');
            ...
            Route::post('/recebimento/loja', 'NoteReceiptController@store')->name('note-receipts.store');
